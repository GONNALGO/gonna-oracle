...
## (c) Piano: free o Starter? — **Starter, e non è un vezzo**
...
continue pagati una volta sola. **Raccomandazione: Starter da subito.**
(La limitazione di banda/CPU dello Starter è più che sufficiente: l'oracle
risponde a poche richieste al minuto.)
